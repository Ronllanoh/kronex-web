    ...
    <div className="hidden items-center gap-8 text-sm text-slate-300 md:flex">
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
          Calcula rápidamente valor neto, IVA y total según la tasa actual de
          Chile (19%).
        </p>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mt-8 space-y-6">
              <div>
                ...
                >
                  <option value="neto">Tengo valor neto</option>
                  <option value="total">Tengo valor total con IVA</option>
                </select>
              </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mt-8 space-y-5">
              <div className="rounded-2xl bg-slate-950 p-5">
                <p className="text-sm text-slate-400">Valor neto</p>
                <p className="mt-2 text-3xl font-bold">{pesos(neto)}</p>
              </div>

              <div className="rounded-2xl bg-slate-950 p-5">
                <p className="text-sm text-slate-400">IVA (19%)</p>
                <p className="mt-2 text-3xl font-bold">{pesos(iva)}</p>
              </div>
